...
public class UITooltipSong : MonoBehaviour
{
	static UITooltipSong mInstance;

	public Camera uiCamera;
	public UILabel text;
	public UISlicedSprite background;
	public UITiledSprite background1;
	...
	void SetText (string tooltipText)
	{
		if (text != null && !string.IsNullOrEmpty(tooltipText))
		{
			...
			if (background != null)
			{
				...
				Transform backgroundTrans1 = background1.transform;
				...
				Vector3 rSize;
				rSize.x = mSize.x * 0.889f;
				rSize.y = mSize.y * 0.889f;
				rSize.z = 1f;
				backgroundTrans1.localScale = rSize;
			}
