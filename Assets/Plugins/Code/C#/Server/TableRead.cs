...
//	public static readonly string SERVER_RES_URL = "http://221.229.162.251:8080/cp/1.2.9Android/Data/";
	...
	public static readonly string SERVER_RES_URL = "http://221.229.162.251:8080/100Test/";
#endif*/
	public static readonly string SERVER_RES_URL = "http://192.168.1.10/cp/1.2.9Android/Data/";
	public static readonly string DATA_NAME = "DataFile.dat";//GameDateZealmTest.ydat
	public static readonly string CONFIG_NAME = "YuanServerRoom.xml";
	//public static readonly string DATA_NAME = "GameDate.ydat";

	//public static readonly string NEW_DATA_NAME = "DataFile.dat";
...
//		MainMenuManage.my.warnings.warningAllEnter.Show(StaticLoc.Loc.Get("info358"), StaticLoc.Loc.Get("meg0093"));
	...
	static void Deserialize() 
	{
		...
		Dictionary<string, yuan.YuanMemoryDB.YuanTable> dicGet  = null;
		// Open the file containing the data that you want to deserialize.
		FileStream fs = new FileStream(LOCAL_RES_PATH + DATA_NAME, FileMode.Open);
		try 
		{
			BinaryFormatter formatter = new BinaryFormatter();
			// Deserialize the hashtable from the file and 
			// assign the reference to the local variable.
			dicGet = (Dictionary<string, yuan.YuanMemoryDB.YuanTable>) formatter.Deserialize(fs);
		}
		catch (SerializationException e) 
		{
			print("Failed to deserialize. Reason: " + e.Message);
			throw;
		}
		finally 
		{
