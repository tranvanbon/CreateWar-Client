...
public class OnLine : MonoBehaviour {
	...
	public string my_site = "192.168.1.10";
...
/*#if UNITY_IOS
			...
			www = new WWW(@"http://221.229.162.251:8080/cp/1.2.6/ServerIP.html");
#endif*/
			www = new WWW(@"http://192.168.1.10/cp/1.2.9Android/ServerIP.htm");
		}
    ...
    public void ConMy()
    {
		serverAddress = "192.168.1.10:9998";
		serverAddress2 = "192.168.1.10:9998";
        StartCoroutine(Connect());
    }
